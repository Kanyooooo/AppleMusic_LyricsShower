...
public sealed partial class TtmlLyricsParser
{
    ...
    public static bool TryParseTime(string? value, out TimeSpan time)
    {
        ...
        if (parts.Length == 1 && double.TryParse(parts[0], NumberStyles.Float, CultureInfo.InvariantCulture, out var secondsOnly))
        {
        ...
        if (parts.Length == 3
            ...
            && double.TryParse(parts[1], NumberStyles.Float, CultureInfo.InvariantCulture, out minutes)
