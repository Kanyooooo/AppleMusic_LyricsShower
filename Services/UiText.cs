...
public sealed class UiText
{
    ...
    public string WindowMode => Language == UiLanguage.English ? "Window mode" : "窗口模式";
    public string NormalWindow => Language == UiLanguage.English ? "Normal window" : "普通窗口";
    ...
    public string Custom => Language == UiLanguage.English ? "Custom" : "自定义";
